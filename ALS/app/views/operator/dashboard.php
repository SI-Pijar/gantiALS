    ...
    <div class="TataLetakAdmin">
      <aside class="SidebarNavigasi">
        ...
        <nav class="MenuNavigasi">
          <a href="index.php?page=operator&action=dashboard" class="ItemMenu aktif">
            <i class="fa-solid fa-gauge-high"></i>
            <span>Dashboard</span>
          </a>
          <a href="index.php?page=operator&action=kelolaPemesanan" class="ItemMenu">
            <i class="fa-solid fa-ticket"></i>
            <span>Kelola Pemesanan</span>
          </a>
          <a href="index.php?page=operator&action=kelolaJadwal" class="ItemMenu">
            <i class="fa-solid fa-calendar-days"></i>
            <span>Kelola Jadwal</span>
          </a>
          <a href="index.php?page=operator&action=kelolaBus" class="ItemMenu">
            <i class="fa-solid fa-bus"></i>
            <span>Kelola Bus</span>
          </a>
        </nav>
        <div class="AreaUserSidebar">
          <a href="index.php?page=operator&action=login" class="TombolLogout">
      ...
      <main class="KontenUtamaAdmin">
        <header class="HeaderKonten">
          ...
          <div class="ProfilAdmin">
            <span>Selamat datang, <strong>Operator Medan</strong></span>
        ...
        <div class="KontenArea">
          ...
          <div class="KartuKontenBesar">
            <h3><i class="fa-solid fa-ticket"></i> Pemesanan Terbaru (Perlu Verifikasi)</h3>
